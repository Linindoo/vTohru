...
import cn.vtohru.mongo.impl.MongoDataStore;
...
@Singleton
public class MongoDataFactory implements DataStoreSpiFactory {
    @Override
    public DataStore createDataStore(VerticleApplicationContext verticleApplicationContext, DataSourceConfiguration dataSourceConfiguration, EntityManager entityManager) {
        return new MongoDataStore(verticleApplicationContext, dataSourceConfiguration, entityManager);
    }
