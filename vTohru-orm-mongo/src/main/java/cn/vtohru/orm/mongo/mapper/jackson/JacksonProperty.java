...
import cn.vtohru.orm.mapping.impl.AbstractProperty;
...
public class JacksonProperty extends AbstractProperty {
   ...
   *
   */
  public JacksonProperty(final MongoMapper<?> mapper, final BeanPropertyDefinition definition) {
    super(mapper);
  ...
  protected void init() {
    ...
    propertyMapper = new JacksonPropertyMapper((MongoDataStore) getMapper().getMapperFactory().getDataStore());
    computeEncoder();
  }
