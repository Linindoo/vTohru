 ...
 * @since 1.0
 */
public class VDefaultEnvironment extends VPropertySourcePropertyResolver implements Environment {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(VDefaultEnvironment.class);
    ...
    private VDefaultEnvironment.EnvironmentsAndPackage environmentsAndPackage;
     ...
     */
    public VDefaultEnvironment(@NonNull ApplicationContextConfiguration configuration) {
        ...
        VDefaultEnvironment.EnvironmentsAndPackage environmentsAndPackage = getEnvironmentsAndPackage(specifiedNames);
    ...
    @Override
    public VDefaultEnvironment addPropertySource(PropertySource propertySource) {
    ...
    @Override
    public VDefaultEnvironment addPropertySource(String name, Map<String, ? super Object> values) {
        return (VDefaultEnvironment) super.addPropertySource(name, values);
    }
    ...
    private VDefaultEnvironment.EnvironmentsAndPackage getEnvironmentsAndPackage(List<String> specifiedNames) {
        VDefaultEnvironment.EnvironmentsAndPackage environmentsAndPackage = this.environmentsAndPackage;
        final boolean extendedDeduction = !specifiedNames.contains(Environment.FUNCTION);
        if (environmentsAndPackage == null) {
            synchronized (VDefaultEnvironment.EnvironmentsAndPackage.class) { // double check
    ...
    private static VDefaultEnvironment.EnvironmentsAndPackage deduceEnvironmentsAndPackage(
        ...
        VDefaultEnvironment.EnvironmentsAndPackage environmentsAndPackage = new VDefaultEnvironment.EnvironmentsAndPackage();
