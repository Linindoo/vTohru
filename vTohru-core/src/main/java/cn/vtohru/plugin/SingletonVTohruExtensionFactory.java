...
/**
 * A {@link VTohruExtensionFactory} that always returns a specific instance.
 * Optional you can specify the extension classes for which you want singletons.
 *
 * @author Decebal Suiu
 */
public class SingletonVTohruExtensionFactory extends VTohruExtensionFactory {

    private final List<String> extensionClassNames;

    private Map<String, Object> cache;

    public SingletonVTohruExtensionFactory(PluginManager pluginManager) {
        this(pluginManager, true);
    }

    public SingletonVTohruExtensionFactory(PluginManager pluginManager, String... extensionClassNames) {
        this(pluginManager, true, extensionClassNames);
    }

    public SingletonVTohruExtensionFactory(PluginManager pluginManager, boolean autowire, String... extensionClassNames) {
