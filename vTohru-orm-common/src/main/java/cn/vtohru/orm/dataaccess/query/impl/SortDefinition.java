...
public class SortDefinition<T> implements ISortDefinition<T> {
   ...
   * (non-Javadoc)
   * 
   * @see cn.vtohru.orm.dataaccess.query.ISortDefinition#addSort(java.lang.String)
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @see cn.vtohru.orm.dataaccess.query.ISortDefinition#addSort(java.lang.String, boolean)
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @see cn.vtohru.orm.dataaccess.query.ISortDefinition#isEmpty()
   */
  @Override
