...
import cn.vtohru.orm.typehandler.IFieldParameterResult;
...
public class DefaultFieldParameterResult implements IFieldParameterResult {
   ...
   * (non-Javadoc)
   * 
   * @see cn.vtohru.orm.typehandler.IFieldParameterResult#getColName()
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @see cn.vtohru.orm.typehandler.IFieldParameterResult#getOperator()
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @see cn.vtohru.orm.typehandler.IFieldParameterResult#getValue()
   */
  @Override
