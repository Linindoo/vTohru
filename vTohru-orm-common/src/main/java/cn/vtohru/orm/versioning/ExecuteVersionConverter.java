...
import cn.vtohru.orm.observer.impl.AbstractObserver;
...
public class ExecuteVersionConverter extends AbstractObserver {
   ...
   * (non-Javadoc)
   * 
   * @see cn.vtohru.orm.observer.IObserver#canHandleEvent(cn.vtohru.orm.observer.
   * IObserverEvent, cn.vtohru.orm.observer.IObserverContext)
   */
  @Override
